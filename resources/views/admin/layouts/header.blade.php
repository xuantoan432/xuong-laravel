                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language"
                            ...
                            <img src="{{ asset('theme/admin/assets/images/flags/spain.svg') }}"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language"
                            ...
                            <img src="{{ asset('theme/admin/assets/images/flags/italy.svg') }}"
                                alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language"
                            ...
                            <img src="{{ asset('theme/admin/assets/images/flags/china.svg') }}"
                                alt="user-image" class="me-2 rounded" height="18">
